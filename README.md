...
<td>Дано: факт запуска А/B-теста на  основе выгрузки данных интернет-магазина. Имея техническое задание и результаты теста, загрузите данные теста, проверьте корректность его проведения и проанализируйте полученные результаты. </td>
